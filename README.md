...
**Status**: v0 — early-stage. API will change.
...
This is an early-stage codebase. The interfaces here are minimal and **expected to break** as the project finds its shape:
